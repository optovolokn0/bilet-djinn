                ...
                <div className="user">
                    {user ? (
                        <>
                            ...
                            <svg className='notification-icon' width="36" height="40" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg className='user-icon' width="36" height="40" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
